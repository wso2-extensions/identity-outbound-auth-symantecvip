                                    ...
                                    <div class="row">
                                        <div class="span6">
                                             ...
                                             <div class="control-group">
                                                <label class="control-label" for="password">Enter the 6-digit Security Code:</label>
                                                <input type="password" id='SecurityCode' name="SecurityCode" class="input-xlarge" size='30'/>
                                             </div>
